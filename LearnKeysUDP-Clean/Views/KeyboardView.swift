...
struct KeyboardView: View {
    ...
    private func modifierOnlyRow() -> some View {
        HStack(spacing: 20) {
            // Left side modifiers
            HStack(spacing: 15) {
                OriginalKeyCap(label: "Shift", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("a"))
                OriginalKeyCap(label: "Control", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("s"))
                OriginalKeyCap(label: "Option", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("d"))
                OriginalKeyCap(label: "F-Nav", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("f"))
                OriginalKeyCap(label: "Command", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("g"))
                }
            ...
            HStack(spacing: 15) {
                OriginalKeyCap(label: "Command", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("j"))
                OriginalKeyCap(label: "Option", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("k"))
                OriginalKeyCap(label: "Control", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive("l"))
                OriginalKeyCap(label: "Shift", symbol: nil as String?, isArrow: false, isActive: animationController.isModifierActive(";"))
                }
        }
        .padding()
            }
